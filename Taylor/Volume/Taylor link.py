        ...
        for row in csv_reader:
            if current_index >= start_index:
                ...
                for link in  soup.find_all('a', href=True):
                    href = link['href']
                    if '/doi/abs/' in link['href']:
                        links.add(href)
                for link in links:
                    article_url = "https://www.tandfonline.com" + link
                    print(article_url)
...
if __name__ == "__main__":
    journal_list = ["Journal of Business and Economic Statistics","Journal of the American Statistical Association"]
